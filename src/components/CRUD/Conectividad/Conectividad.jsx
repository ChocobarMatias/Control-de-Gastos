  ...
  const hideAlert = () => {
    ...
    return (
      ...
      <div className="header-container">
        ...
        <Form>
          <Form.Group className="input-main-conec mb-3" controlId="exampleForm.ControlInput1">
            <Form.Label>-- Monto Total a pagar de Conectividad: $</Form.Label>
        ...
        <div className="toggle-container text-primary" onClick={handleCollapseToggle}>
          <b className="mostar3">{open ? "Mostrar Menos..." : "Mostrar Mas..."}</b>
          {open ? (
              ...
              <MDBTable bordered borderColor="primary" style={{ color: 'red', fontSize: '24px' }}>
                <MDBTableHead className="text-white">
                  <tr>
                    ...
                    <th scope="col" className="bg-warning">Nombre de Conectividad</th>
