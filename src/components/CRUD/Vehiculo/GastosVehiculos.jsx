  ...
  return (
    <div>
      ...
      <div className="header-container">
        ...
        <Form>
          <Form.Group className="input-main-vehiculo mb-3" controlId="exampleForm.ControlInput1">
            <Form.Label>-- Monto Total a pagar de Gastos Vehiculos: $</Form.Label>
        ...
        <div className="toggle-container text-primary" onClick={handleCollapseToggle}>
          <b className="mostar5">{open ? "Mostrar Menos..." : "Mostrar Mas..."}</b>
          {open ? (
