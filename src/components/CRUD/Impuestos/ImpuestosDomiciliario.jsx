...
const ImpuestosDomiciliario = () => {
  ...
  const getTarjeta = async () => {
    try {
      let response = await axios.get("http://localhost:3000/Conectividad");
  ...
  const handleClick = async (id) => {
    try {
      ...
      let response = await axios.delete("http://localhost:3000/Conectividad/" + id);
      if (response) {
        setShowAlert3(true);
  ...
  const hideAlert = () => {
    ...
    return (
      ...
      <div className="header-container">
        ...
        <Form>
          <Form.Group className="input-main-impuesto mb-3" controlId="exampleForm.ControlInput1">
            <Form.Label>-- Monto Total a pagar de Impuestos: $</Form.Label>
        ...
        <div className="toggle-container text-primary" onClick={handleCollapseToggle}>
          <b className="mostar2">{open ? "Mostrar Menos..." : "Mostrar Mas..."}</b>
          {open ? (
        ...
        <div id="example-collapse-text">
          <div className="contenedorTarjeta">
            <Row>
              ...
              <br />
              <br />
              <MDBTable bordered borderColor="primary" style={{ color: 'red', fontSize: '24px' }}sa>
...
export default ImpuestosDomiciliario
